      ...
      <div className="accordion" id="accordionExample" >
        <div className="accordion-item">
          <h2 className="accordion-header" id="headingOne">
            <button
              className="accordion-button glowClass"
              type="button"
          ...
          >
            <div className="accordion-body glowClass" style={myStyle}>
...
With our text analysis feature, you can input any text and get a report on various aspects of it, such as the word count, character count, number of unique words, reading level, and more.
        ...
        <div className="accordion-item">
          <h2 className="accordion-header" id="headingTwo">
            <button
              className="accordion-button collapsed glowClass"
              type="button"
              data-bs-toggle="collapse"
        ...
        <div className="accordion-item">
          ...
          <div
            id="collapseThree"
            className="accordion-collapse collapse glowClass"
